...
function anyChildActive(
  ...
  return children.some(
    (c) => isActive(c.pathname, pathname) || anyChildActive(c.children, pathname),
  );
}
...
function MenuItem({
  ...
  const active = isActive(item.pathname, pathname);
  console.log("item", item)
  console.log("Rendering menu item:", item.title, "active:", active);
